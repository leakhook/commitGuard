// Action: read file lists and staged blobs via git commands.
...
// Staged (added/modified/copied) file paths. Deletions are excluded.
...
// Staged blob content (from the index). Reads what will be committed, regardless of working-tree edits.
